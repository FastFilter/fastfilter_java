...
public class MonotoneList2 {
    ...
    public static MonotoneList2 generate(int[] data, BitBufferDirect buffer) {
        ...
        buffer.seek(start);
        return new MonotoneList2(buffer);
    }
    ...
    public static MonotoneList2 load(BitBufferDirect buffer) {
        return new MonotoneList2(buffer);
    }
